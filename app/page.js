      ...
      <div className="m-auto w-11/12 ">
        ...
        <main className="main ">
          <div className="flex flex-col gap-4 mb-6">
            <h1 className="text-center text-4xl font-black leading-[1.15] text-black sm:text-6xl">
              WHAT ARE YOU COOKING TODAY?
            </h1>
            <p className="bg-gradient-to-r from-amber-500 via-orange-600 to-yellow-500 bg-clip-text text-transparent text-center text-2xl font-bold">
              Unlock the door to code mastery with our online editor
            </p>
          </div>
          <div className="z-30 -mb-4">
            {!user ? (
              <Button className="bg-[#EE7D2F] " onClick={signInHandle}>
                Start Cooking
                {loading ? (
          ...
          <div className="absolute z-30 right-0 text-2xl flex flex-col gap-3">
            <a href="https://github.com/Rehamatjani" target="_blank">
              <TbBrandGithubFilled className="hover:text-orange-500" />
            </a>
            <a href="rahamathjani786@gmail.com" target="_blank">
